        ...
        <div className="mt-16 grid gap-8 lg:grid-cols-[0.82fr_1.18fr]">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm tracking-[0.12em] text-[var(--lale-gold)]">BLACKSTAR AVANTAJLARI</p>
            ...
            {reviews.map((review, index) => (
              ...
              >
                ...
                <div className="mt-5 flex items-center justify-between border-t border-[rgba(223,167,69,0.12)] pt-4">
                  ...
                  <span className="text-xs text-[var(--dream-text)]">Blackstar misafir yorumu</span>
                </div>
              </motion.article>
            ))}
          </div>
