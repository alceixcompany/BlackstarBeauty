      ...
      <div className="relative mx-auto max-w-6xl px-6">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div>
              ...
              <h3 className="mt-4 max-w-xl font-serif text-3xl leading-tight sm:text-4xl">
                Blackstar Beauty ile bakım planınızı hızlıca oluşturalım
              </h3>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              >
                ...
                <p className="mt-2 text-base font-medium">0546 906 4334</p>
              </a>
              ...
              >
                ...
                <p className="mt-2 text-base font-medium">@blackstarbeautyy</p>
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="mb-14 grid grid-cols-1 gap-6 md:grid-cols-3">
          <div className="rounded-[28px] border border-[rgba(223,167,69,0.16)] bg-white/[0.88] p-7 text-center shadow-[0_18px_50px_rgba(95,89,108,0.08)]">
            ...
            <a href="tel:+905469064334" className="text-lg font-medium text-[var(--lale-gold)] transition-colors hover:text-[var(--lale-gold-soft)]">
              +90 546 906 43 34
            </a>
