...
const NewsPage = () => {
  ...
  return (
    <div className="page-flow min-h-screen bg-[var(--lale-emerald-deep)]">
      <PageHero
        eyebrow="Güzellik Günlüğü"
        title={<>Haberler<br />& duyurular</>}
        description="Güzellik dünyasındaki trendler, bakım önerileri ve Blackstar’daki yenilikleri sade ve modern bir editöryel sunumla takip edin."
        image="/banner/blackstar_brand_main.png"
        imageAlt="Blackstar Beauty haberler"
      />
