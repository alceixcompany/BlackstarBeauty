...
const HaberDetay = () => {
  ...
  const shareOnWhatsApp = () => {
    ...
    const url = `https://wa.me/905469064334/?text=${encodeURIComponent(text)}`;
  ...
  return (
    <div className="page-flow min-h-screen bg-[var(--lale-emerald-deep)]">
      <PageHero
        eyebrow="Blog Yazısı"
        title={<>{haber?.title}</>}
        description={haber?.subtitle || 'Blackstar Beauty editöryel notları ve bakım dünyasından güncel içerikler.'}
        image="/banner/blackstar_brand_main.png"
        imageAlt="Blackstar Beauty haber detayı"
