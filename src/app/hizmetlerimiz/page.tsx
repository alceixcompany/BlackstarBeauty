  ...
  return (
    <main className="page-flow min-h-screen bg-[var(--lale-emerald-deep)]">
      <PageHero
        ...
        description="Cildinize, bedeninize ve ruhunuza iyi gelecek uzman uygulamalarımızı daha rafine ve modern bir deneyimle keşfedin."
        image="/banner/blackstar_brand_services.png"
        imageAlt="Blackstar Beauty hizmetleri"
      />
